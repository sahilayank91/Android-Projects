...
public class Teamzinecard extends ActionBarActivity {

    private RecyclerView mRecyclerView;
    private RecyclerView.Adapter mAdapter;
    private RecyclerView.LayoutManager mLayoutManager;
    private static String LOG_TAG = "Teamzinecard";
    ...
    protected void onResume() {
        ...
        ((MyRecyclerViewAdapter) mAdapter).setOnItemClickListener(new MyRecyclerViewAdapter
            ...
            public void onItemClick(int position, View v) {
                ...
                if(position==0)
                {
                    Intent human = new Intent(Teamzinecard.this,HumanComputerInterface.class);
                    startActivity(human);
                }else if (position==1)
                {
                    Intent bci = new Intent(Teamzinecard.this,BrainComputingInterface.class);
                    startActivity(bci);
                }else if(position==2){
                    Intent quad = new Intent(Teamzinecard.this,AutonomousQuadcopter.class);
                    startActivity(quad);

                }else if(position==3){
                    Intent gait = new Intent(Teamzinecard.this,HomeEnergy.class);
                    startActivity(gait);

                }else if(position==4){
                    Intent gait = new Intent(Teamzinecard.this,GairAnalysis.class);
                    startActivity(gait);

                }
                else if(position==5){
                    Intent malti = new Intent(Teamzinecard.this,MultiActuator.class);
                    startActivity(malti);

                }else if(position==6){
                    Intent vol = new Intent(Teamzinecard.this,VoltageInspection.class);
                    startActivity(vol);
                }else if(position==7){
                    Intent smart = new Intent(Teamzinecard.this,SmartGrid.class);
                    startActivity(smart);

                }else if(position==8){
                    Intent exo = new Intent(Teamzinecard.this,Exoskeleton.class);
                    startActivity(exo);

                }else if(position==9){
                    Intent agas = new Intent(Teamzinecard.this,Agastuti.class);
                    startActivity(agas);

                }else if(position==10){
                    Intent hand = new Intent(Teamzinecard.this,HandGesture.class);
                    startActivity(hand);

                }else if(position==11){
                    Intent sun = new Intent(Teamzinecard.this,SunTracker.class);
                    startActivity(sun);

                }else if(position==12){
                    Intent arm = new Intent(Teamzinecard.this,ProstheticArm.class);
                    startActivity(arm);

                }else if(position==13) {
                    Intent wh = new Intent(Teamzinecard.this, AutonomousWheelchair.class);
                    startActivity(wh);
                }
