...
//        Modify the DefaultItemAnimator
  RecyclerView.ItemAnimator itemAnimator = new DefaultItemAnimator();
    ...
    public List<Data> fill_with_data() {
        ...
        data.add(new Data("Various Patents Filed","Patent titled, \"Robotic Technology for Transmission Line Inspection in Live Condition\" \n" +
                "\n" +
                "Patent titled, \"Rail Alert Systems\"\n" +
                "Patent titled, \"Railway Maintenance Monitoring System\"\n" +
                "Patent titled, \"Black Pearl-Mouse and Keyboard for SID Children\"\n" +
                "Patent titled, \"Solar operated Tricycle for Handicap people\"\n" +
                "Patent titled, \"Biofeedback through electronic Goniometer\"\n" +
                "Patent titled, \"Smart Card based Real Time Emission Measurement and Pollution Control Enforcement\"\n" +
                "\n" +
                "Patent titled, \"Comprehensive System for Osteoarthritis detection, analysis and rehabilitation based on\n" +
                "efficient SEMG signals " , R.drawable.ic_bookmark_border_black_24dp));
        data.add(new Data("Robotsav","Organised Robotsav, Technical competetions at Blitzchlag 16, the annual Techno cultural fest of MNIT", R.drawable.ic_bookmark_border_black_24dp));
        data.add(new Data("Kshitij’16 IIT, Kharagpur", "Qualified for the finals in all the events participated", R.drawable.ic_bookmark_border_black_24dp));
        data.add(new Data("Blitzschlag 2016, MNIT Jaipur", "1st in Salvator event\n 4th in the Frodo Hockey Event ", R.drawable.ic_bookmark_border_black_24dp));
        data.add(new Data("GridTech’15, Pragati Maidan, New Delhi", "-Won 1st prize at Students Innovation Pavillion worth of Rs. 1 lakh in the Category Robotic Technology in Inspection of Transmission Lines.\n" +
                "-Won 2nd prize at Students Innovation Pavillion worth of Rs. 50 thousand. ", R.drawable.ic_bookmark_border_black_24dp));
        ...
        data.add(new Data("Projects Approved", "-5 projects were approved by the TEQIP worth of 2.5 lakh from Malaviya National Institute of Technology(MNIT Jaipur). \n" +
