...
public class PracticalFragment extends Fragment {
        ...
        public ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra(PracticalDetailActivity.EXTRA_POSITION, getAdapterPosition());
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mPlaces = resources.getStringArray(R.array.workshop_practicals);
            mPlaceDesc = resources.getStringArray(R.array.workshop_desc);
