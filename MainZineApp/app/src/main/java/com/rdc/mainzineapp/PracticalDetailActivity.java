...
public class PracticalDetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView placename = (TextView) findViewById(R.id.place_detail);
        placename.setText(placeName[postion % placeName.length]);

        String[] placeDetails = resources.getStringArray(R.array.practical_desc);
        TextView placeDetail = (TextView) findViewById(R.id.place_achievement);
        placeDetail.setText(placeDetails[postion % placeDetails.length]);

        String[] placeMember = resources.getStringArray(R.array.workshop_contact);
        TextView placemem = (TextView)findViewById(R.id.place_location);
