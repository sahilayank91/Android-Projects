...
import com.example.root.stickynotes.Pedometer.PedometerActivity;
                ...
                new NavigationView.OnNavigationItemSelectedListener() {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        if (id == R.id.nav_home) {
                            ...
                            finish();
                            startActivity(new Intent(MainActivity.this,DeletedToDo.class));
                        }else if (id==R.id.nav_pedo){
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!msg.isEmpty() && !head.isEmpty()) {
                            ...
                            Toast.makeText(MainActivity.this, "Some of the Inputs were not filled.", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
                        }
                    }
                });
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!head.isEmpty()) {
                            ...
                            Log.e("head",head);
                            startActivity(i);
                            Toast.makeText(MainActivity.this,"No such title found in the database..",Toast.LENGTH_LONG).show();
                            db.close();
                        } else {
                            Toast.makeText(MainActivity.this, "Some of the Inputs were not filled.", Toast.LENGTH_SHORT).show();
                            dialog.dismiss();
...
/*        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new SetStickersFragment(), "To Do list");
