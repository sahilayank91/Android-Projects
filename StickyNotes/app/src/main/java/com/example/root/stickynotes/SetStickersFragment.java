 ...
 */
public class SetStickersFragment extends Fragment {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(LayoutInflater inflater, ViewGroup parent) {
            ...
            wc= (TextView) itemView.findViewById(R.id.wl);
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public Integer[] wordcount = new Integer[100];
        ...
        public ContentAdapter(Context context) {
            ...
            for (Notify cn : notifyList) {
                ...
                wordcount[count] = message[count].length();
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.wc.setText(wordcount[position % 100].toString());
