...
public class WorkshopDetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String[] placetitle = resources.getStringArray(R.array.workshop_desc);
        TextView placetitles = (TextView) findViewById(R.id.place_title);
        placetitles.setText(placetitle[postion % placetitle.length]);

        String[] placetopic = resources.getStringArray(R.array.workshop_desc);
        ...
        String[] placeDetails = resources.getStringArray(R.array.workshop_desc);
