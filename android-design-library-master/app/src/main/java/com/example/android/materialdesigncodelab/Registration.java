...
public class Registration extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNameView = (AutoCompleteTextView)findViewById(R.id.stud_name);
        mPhoneView=(EditText)findViewById(R.id.stud_phone);

        mIdView = (EditText) findViewById(R.id.college_id);
    ...
    private void attemptLogin() {
        ...
        if (!TextUtils.isEmpty(password) && !isPasswordValid(password)) {
            mIdView.setError(getString(R.string.error_invalid_collegeid));
            focusView = mIdView;
            cancel = true;
        }
        //check for the empty name block
        ...
        //checking for the valid phone no and whether it is Empty or Not
        ...
        {
            mPhoneView.setError("The Phone no is invalid");
            focusView =mPhoneView;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            backgroundWorker.execute(type,mNameView.getText().toString(),mEmailView.getText().toString(),mPhoneView.getText().toString(),mIdView.getText().toString(),spinner.getSelectedItem().toString(),hosteller);
        }
    }
